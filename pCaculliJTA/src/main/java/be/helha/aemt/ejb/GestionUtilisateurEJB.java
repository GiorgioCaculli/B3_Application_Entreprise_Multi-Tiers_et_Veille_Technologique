...
public class GestionUtilisateurEJB implements IGestionUtilisateurEJB
{
    ...
    public String init()
    {
        ...
        sb.append( articleDAO.create( caculliArticle ) ).append( "\n" );
        ...
        sb.append( utilisateurDAO.create( caculliUtilisateur1 ) ).append( "\n" );
        sb.append( utilisateurDAO.create( caculliUtilisateur2 ) ).append( "\n" );
